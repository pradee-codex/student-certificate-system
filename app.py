...
def admin_export_zip():
    ...
    try:
        ...
        print("GOOGLE DRIVE SERVICE ERROR:", e)

        flash(
            "Google Drive service could not be connected.",
            "danger"
        )
    ...
    try:
            ...
            for row in certificates:
                ...
                try:
                    ...
                    if not safe_student_name:
                        ...
                        safe_student_name = "Unknown_Student"
        ...
        flash(
            "Unable to create certificate ZIP.",
            "danger"
        )
...
def leaderboard():
    ...
    try:
        ...
        # =========================================
        # HOD
        # Show ALL students from HOD department
        # =========================================
        ...
        # =========================================
            ...
            # -----------------------------------------
            # Tutor has class year + section
            # Show only allotted class students
            # -----------------------------------------

            if tutor_year is not None and tutor_section is not None:
